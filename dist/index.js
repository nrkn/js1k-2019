    ...
    let draw = () => {
        ...
        for (let viewY = 0; viewY < VIEWSIZE; viewY++) {
            for (let viewX = 0; viewX < VIEWSIZE; viewX++) {
                ...
                else if (mapData[key(mapX, mapY)] === stairs) {
        ...
        for (let i = 0; i < monsters.length; i++) {
            if (x || y) {
                ...
                if (monsters[i][2]) {
                    ...
                    else if (mapData[key(monsters[i][0] + mx, monsters[i][1] + my)] === floor
                        ||
                            mapData[key(monsters[i][0] + mx, monsters[i][1] + my)] === floor2) {
                        monsters[i] = [
                            monsters[i][0] + mx,
                            monsters[i][1] + my,
                            monsters[i][2]
